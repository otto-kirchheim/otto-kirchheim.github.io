...
- **Feinschliff nach Praxistest:** Desktop-Breakdown-Zellen bleiben in Monaten ohne Zulagen leer (wie EWT-Zeilen). Mobil werden Zulagen unabhängig von der Jahres-Code-Anzahl angezeigt, aber nur Codes mit Monatswert > 0 (keine Zeilen, wenn alle 0); EWT-Schwellen als kompakte Einzelzeilen (`Abwesenheiten >8 Std.`), Nullwerte weggelassen.
