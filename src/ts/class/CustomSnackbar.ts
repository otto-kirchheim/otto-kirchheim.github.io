  ...
  constructor(options: SnackBarOptions) {
    ...
    function _setContainer(): HTMLDivElement | HTMLElement {
      ...
      if (target === undefined || target === null) {
        const containerName =
          typeof _This._Options.container === 'string'
            ? _This._Options.container
            : _This._Options.container.tagName.toLowerCase();
    ...
    function _createMessage(): {
      ...
      function insertMessageTo(element: HTMLDivElement): {
        _Message: HTMLSpanElement;
        _MessageWrapper: HTMLDivElement;
      } {
      ...
      function setWidth(element: HTMLDivElement): void {
        ...
        element.style.width = `${_This._Options.width}px`;
      }
