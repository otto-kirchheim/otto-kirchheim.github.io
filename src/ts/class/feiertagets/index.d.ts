 ...
 */
declare function addTranslation(isoCode: string, newTranslation: TranslationTable): void;
...
declare function isSpecificHoliday(date: Date, holidayName: HolidayType, region: Region): boolean;
