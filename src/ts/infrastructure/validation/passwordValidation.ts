...
/**
 * Prueft die Passwortlaenge (`PASSWORD_MIN_LENGTH` bis `PASSWORD_MAX_LENGTH`).
 *
 * @param password - Zu pruefendes Passwort.
 * @param subject - Bezeichnung des Passworts im Meldungstext.
 * @returns Fehlermeldung, oder `null` bei gueltiger Laenge.
 */
