...
import { LOGIN_INIT_SEQUENCE, validateInitSequence } from '../../src/ts/core/orchestration/initSequence';

describe('initSequence', () => {
  it('LOGIN_INIT_SEQUENCE has no dangling dependencies', () => {
    expect(() => validateInitSequence(LOGIN_INIT_SEQUENCE)).not.toThrow();
  });
