...
vi.mock('@/features/ber/model/saveTableDataVorgabenU', () => ({ default: vi.fn() }));
vi.mock('@/features/ber/model/generateEingabeTabelleEinstellungenVorgabenB', () => ({ default: vi.fn() }));
...
import {
  ...
  msToSliderPosition,
  sliderPositionToMs,
} from '@/pages/einstellungen/model/generateEingabeMaskeEinstellungen';
...
import { default as saveTableDataVorgabenU } from '@/features/ber/model/saveTableDataVorgabenU';
