...
import BerechnungMobileCards from '@/pages/berechnung/ui/BerechnungMobileCards';
import { mountBerechnungMobileCards } from '@/pages/berechnung/ui/mountBerechnung';
...
} from '@/pages/berechnung/ladeBerechnungsTeile';
...
describe('#BerechnungMobileCards', () => {
  ...
  it('wird über generateTableBerechnung mit gerendert (Integration)', async () => {
    ...
    const { default: generateTableBerechnung } = await import('@/pages/berechnung/generateTableBerechnung');
