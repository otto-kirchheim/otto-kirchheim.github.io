...
import type { AdminUserRow, BulkApplyResult, BulkUserProfileUpdatePayload } from '@/pages/admin/api/api';
...
const { AdminBulkEditModal } = await import('@/pages/admin/ui/AdminBulkEditModal');
