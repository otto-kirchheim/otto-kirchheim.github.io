...
import type { AdminUserRow } from '@/pages/admin/api/api';
...
vi.mock('@/pages/admin/ui/createAdminBulkEditModal', () => ({
  default: mockCreateAdminBulkEditModal,
}));
vi.mock('@/pages/admin/ui/createAdminUserPasswordModal', () => ({ default: vi.fn() }));
vi.mock('@/pages/admin/ui/createAdminUserLinksModal', () => ({ default: vi.fn() }));
vi.mock('@/pages/admin/model/actAs', () => ({ loadUserDataForAdminSelection: vi.fn() }));

const { AdminUserList } = await import('@/pages/admin/ui/AdminUserList');
