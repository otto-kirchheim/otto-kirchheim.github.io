...
vi.mock('@/pages/admin/ui/AdminUserList', () => ({ AdminUserList: () => 'AdminUserList' }));
vi.mock('@/pages/admin/ui/AdminVorgabenEditor', () => ({
  AdminVorgabenEditor: () => 'AdminVorgabenEditor',
}));
vi.mock('@/pages/admin/ui/AdminProfileTemplatesManager', () => ({
  AdminProfileTemplatesManager: () => 'AdminProfileTemplatesManager',
}));
vi.mock('@/pages/admin/ui/AdminDashboard', () => ({ AdminDashboard: () => 'AdminDashboard' }));
vi.mock('@/pages/admin/ui/AdminResourceBrowser', () => ({
  AdminResourceBrowser: () => 'AdminResourceBrowser',
}));
vi.mock('@/pages/admin/ui/AdminUserProfileEditor', () => ({
  AdminUserProfileEditor: () => 'AdminUserProfileEditor',
}));
vi.mock('@/pages/admin/ui/AdminLogBrowser', () => ({ AdminLogBrowser: () => 'AdminLogBrowser' }));
vi.mock('@/pages/admin/ui/FormularUpload', () => ({ FormularUpload: () => 'FormularUpload' }));
