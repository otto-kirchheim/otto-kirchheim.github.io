...
import { escapeHtml, markErrorRows, markFetchErrorRows, showErrorDialog } from '@/shared/lib/autosave/errorHandling';
...
import type { RowErrorMatch } from '@/shared/lib/autosave/savePipeline';
