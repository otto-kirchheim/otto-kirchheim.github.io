...
import {
  ...
  summeUeberListe,
  trifftBedingung,
} from '@/shared/lib/pdf/aggregatoren';
...
describe('alsVergleichswert (Bedingung.bereich, feldunabhängig)', () => {
  ...
  it('liest echte Booleans als 1/0 -- bereich:{von:1,bis:2} bleibt für Boolean-Zeilenfelder (z.B. `features/ewt/model/pdfDaten.ts`) als Altweg gültig, auch nachdem werte direkt boolean unterstützt', () => {
