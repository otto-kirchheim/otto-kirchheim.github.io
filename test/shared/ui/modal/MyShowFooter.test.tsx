...
const { default: MyShowFooter } = await import('@/shared/ui/modal/MyShowFooter');
...
describe('MyShowFooter', () => {
  it('should render Bearbeiten-, Löschen- and Schließen-Buttons', () => {
    ...
    // Seit Phase J6b rendert MyShowFooter direkt DBButton (MyButton aufgeloest). Farb-
    // Konvention (Phase I): destruktiv = `outlined`+`critical`, weniger Gewicht als die
    // `brand`-Primaeraktion.
