...
import {
  ...
  ZEILEN_QUELLEN,
  type FormularCode,
} from '@/features/Admin/components/FormularEditor/datenKatalog';
 ...
 * `features/Admin/features/<key>/katalog.ts` zusammen statt aus Records in einer Datei); haelt die bisherige, unveraenderte
 * Ausgabe fest.
 */
